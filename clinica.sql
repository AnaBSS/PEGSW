...
CREATE FUNCTION fn_pesquisarpaciente(@cpf CHAR(15))
RETURNS @table TABLE (
  cpf CHAR(11),
  nome VARCHAR(100),
  cartaoSus VARCHAR(15),
...
GO
CREATE FUNCTION fn_pacientepesquisaconsultas (@cpf CHAR(11))
RETURNS @table TABLE (
  data VARCHAR(10),
  hora VARCHAR(5),
  paciente VARCHAR(100),
...
SELECT * FROM fn_pacientepesquisaconsultas('04488308848')
